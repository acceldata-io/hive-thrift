...
public class CheckLockRequest implements org.apache.thrift.TBase<CheckLockRequest, CheckLockRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CheckLockRequest> {
  ...
  public CheckLockRequest setTxnid(long txnid) {
    this.txnid = txnid;
    setTxnidIsSet(true);
    return this;
  }
  ...
  public CheckLockRequest setElapsedMs(long elapsed_ms) {
    this.elapsed_ms = elapsed_ms;
    setElapsedMsIsSet(true);
    return this;
  }

  public void unsetElapsedMs() {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ELAPSED_MS:
      if (value == null) {
        ...
        setElapsedMs((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(CheckLockRequest that) {
    ...
    boolean this_present_elapsed_ms = true && this.isSetElapsedMs();
    boolean that_present_elapsed_ms = true && that.isSetElapsedMs();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetElapsedMs()) ? 131071 : 524287);
    if (isSetElapsedMs())
  ...
  public int compareTo(CheckLockRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetElapsedMs(), other.isSetElapsedMs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetElapsedMs()) {
