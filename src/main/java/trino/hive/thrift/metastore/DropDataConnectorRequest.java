...
public class DropDataConnectorRequest implements org.apache.thrift.TBase<DropDataConnectorRequest, DropDataConnectorRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DropDataConnectorRequest> {
  ...
  public DropDataConnectorRequest setConnectorName(@org.apache.thrift.annotation.Nullable java.lang.String connectorName) {
    this.connectorName = connectorName;
    return this;
  }
  ...
  public DropDataConnectorRequest setIfNotExists(boolean ifNotExists) {
  ...
  public DropDataConnectorRequest setCheckReferences(boolean checkReferences) {
