...
public class GetOpenTxnsRequest implements org.apache.thrift.TBase<GetOpenTxnsRequest, GetOpenTxnsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetOpenTxnsRequest> {
  ...
  public GetOpenTxnsRequest setExcludeTxnTypes(@org.apache.thrift.annotation.Nullable java.util.List<TxnType> excludeTxnTypes) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem1545 = io.trino.hive.thrift.metastore.TxnType.findByValue(iprot.readI32());
                  if (_elem1545 != null)
                  {
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            _elem1550 = io.trino.hive.thrift.metastore.TxnType.findByValue(iprot.readI32());
            if (_elem1550 != null)
            {
