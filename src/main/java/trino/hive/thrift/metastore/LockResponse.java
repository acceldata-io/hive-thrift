...
public class LockResponse implements org.apache.thrift.TBase<LockResponse, LockResponse._Fields>, java.io.Serializable, Cloneable, Comparable<LockResponse> {
   ...
   * @see LockState
   */
  public LockResponse setState(@org.apache.thrift.annotation.Nullable LockState state) {
    this.state = state;
    return this;
  }
  ...
  public LockResponse setErrorMessage(@org.apache.thrift.annotation.Nullable java.lang.String errorMessage) {
