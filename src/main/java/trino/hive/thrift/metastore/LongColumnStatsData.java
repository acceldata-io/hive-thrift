...
public class LongColumnStatsData implements org.apache.thrift.TBase<LongColumnStatsData, LongColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<LongColumnStatsData> {
  ...
  public LongColumnStatsData setBitVectors(byte[] bitVectors) {
    this.bitVectors = bitVectors == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(bitVectors.clone());
    return this;
  }

  public LongColumnStatsData setBitVectors(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer bitVectors) {
  ...
  public LongColumnStatsData setHistogram(byte[] histogram) {
    this.histogram = histogram == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(histogram.clone());
    return this;
  }

  public LongColumnStatsData setHistogram(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer histogram) {
