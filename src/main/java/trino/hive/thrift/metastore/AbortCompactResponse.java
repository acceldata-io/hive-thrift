...
public class AbortCompactResponse implements org.apache.thrift.TBase<AbortCompactResponse, AbortCompactResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AbortCompactResponse> {
  ...
  public AbortCompactResponse(AbortCompactResponse other) {
    if (other.isSetAbortedcompacts()) {
      java.util.Map<java.lang.Long,AbortCompactionResponseElement> __this__abortedcompacts = new java.util.TreeMap<java.lang.Long,AbortCompactionResponseElement>();
  ...
  public void putToAbortedcompacts(long key, AbortCompactionResponseElement val) {
    if (this.abortedcompacts == null) {
      this.abortedcompacts = new java.util.TreeMap<java.lang.Long,AbortCompactionResponseElement>();
    }
  ...
  public AbortCompactResponse setAbortedcompacts(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Long,AbortCompactionResponseElement> abortedcompacts) {
    this.abortedcompacts = abortedcompacts;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (abortedcompacts == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'abortedcompacts' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.abortedcompacts = new java.util.TreeMap<java.lang.Long,AbortCompactionResponseElement>();
                long _key943;
