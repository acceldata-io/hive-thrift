...
public class SQLAllTableConstraints implements org.apache.thrift.TBase<SQLAllTableConstraints, SQLAllTableConstraints._Fields>, java.io.Serializable, Cloneable, Comparable<SQLAllTableConstraints> {
  ...
  public SQLAllTableConstraints setPrimaryKeys(@org.apache.thrift.annotation.Nullable java.util.List<SQLPrimaryKey> primaryKeys) {
  ...
  public SQLAllTableConstraints setForeignKeys(@org.apache.thrift.annotation.Nullable java.util.List<SQLForeignKey> foreignKeys) {
  ...
  public SQLAllTableConstraints setUniqueConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLUniqueConstraint> uniqueConstraints) {
  ...
  public SQLAllTableConstraints setNotNullConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLNotNullConstraint> notNullConstraints) {
  ...
  public SQLAllTableConstraints setDefaultConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLDefaultConstraint> defaultConstraints) {
  ...
  public SQLAllTableConstraints setCheckConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLCheckConstraint> checkConstraints) {
