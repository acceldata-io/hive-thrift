...
public class CreateTableRequest implements org.apache.thrift.TBase<CreateTableRequest, CreateTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTableRequest> {
  ...
  public CreateTableRequest setTable(@org.apache.thrift.annotation.Nullable Table table) {
    this.table = table;
    return this;
  }
  ...
  public CreateTableRequest setEnvContext(@org.apache.thrift.annotation.Nullable EnvironmentContext envContext) {
  ...
  public CreateTableRequest setPrimaryKeys(@org.apache.thrift.annotation.Nullable java.util.List<SQLPrimaryKey> primaryKeys) {
  ...
  public CreateTableRequest setForeignKeys(@org.apache.thrift.annotation.Nullable java.util.List<SQLForeignKey> foreignKeys) {
  ...
  public CreateTableRequest setUniqueConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLUniqueConstraint> uniqueConstraints) {
  ...
  public CreateTableRequest setNotNullConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLNotNullConstraint> notNullConstraints) {
  ...
  public CreateTableRequest setDefaultConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLDefaultConstraint> defaultConstraints) {
  ...
  public CreateTableRequest setCheckConstraints(@org.apache.thrift.annotation.Nullable java.util.List<SQLCheckConstraint> checkConstraints) {
  ...
  public CreateTableRequest setProcessorCapabilities(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> processorCapabilities) {
  ...
  public CreateTableRequest setProcessorIdentifier(@org.apache.thrift.annotation.Nullable java.lang.String processorIdentifier) {
