...
public class PrincipalPrivilegeSet implements org.apache.thrift.TBase<PrincipalPrivilegeSet, PrincipalPrivilegeSet._Fields>, java.io.Serializable, Cloneable, Comparable<PrincipalPrivilegeSet> {
  ...
  public PrincipalPrivilegeSet(PrincipalPrivilegeSet other) {
    if (other.isSetUserPrivileges()) {
      java.util.Map<java.lang.String,java.util.List<PrivilegeGrantInfo>> __this__userPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
    ...
    if (other.isSetGroupPrivileges()) {
      java.util.Map<java.lang.String,java.util.List<PrivilegeGrantInfo>> __this__groupPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
    ...
    if (other.isSetRolePrivileges()) {
      java.util.Map<java.lang.String,java.util.List<PrivilegeGrantInfo>> __this__rolePrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
  ...
  public void putToUserPrivileges(java.lang.String key, java.util.List<PrivilegeGrantInfo> val) {
    if (this.userPrivileges == null) {
      this.userPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
    }
  ...
  public void putToGroupPrivileges(java.lang.String key, java.util.List<PrivilegeGrantInfo> val) {
    if (this.groupPrivileges == null) {
      this.groupPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
    }
  ...
  public void putToRolePrivileges(java.lang.String key, java.util.List<PrivilegeGrantInfo> val) {
    if (this.rolePrivileges == null) {
      this.rolePrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.userPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.groupPrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.rolePrivileges = new java.util.TreeMap<java.lang.String,java.util.List<PrivilegeGrantInfo>>();
