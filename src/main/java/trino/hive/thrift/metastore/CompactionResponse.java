...
public class CompactionResponse implements org.apache.thrift.TBase<CompactionResponse, CompactionResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CompactionResponse> {
  ...
  public CompactionResponse setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public CompactionResponse setState(@org.apache.thrift.annotation.Nullable java.lang.String state) {
    this.state = state;
    return this;
  }
  ...
  public CompactionResponse setAccepted(boolean accepted) {
    this.accepted = accepted;
    setAcceptedIsSet(true);
    return this;
  }
  ...
  public CompactionResponse setErrormessage(@org.apache.thrift.annotation.Nullable java.lang.String errormessage) {
