...
public class AbortTxnsRequest implements org.apache.thrift.TBase<AbortTxnsRequest, AbortTxnsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AbortTxnsRequest> {
  ...
  public AbortTxnsRequest setTxnIds(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> txn_ids) {
    this.txn_ids = txn_ids;
    return this;
  }
  ...
  public AbortTxnsRequest setErrorCode(long errorCode) {
  ...
  public boolean equals(AbortTxnsRequest that) {
    ...
    boolean this_present_txn_ids = true && this.isSetTxnIds();
    boolean that_present_txn_ids = true && that.isSetTxnIds();
