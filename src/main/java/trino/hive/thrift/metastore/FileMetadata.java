...
public class FileMetadata implements org.apache.thrift.TBase<FileMetadata, FileMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<FileMetadata> {
  ...
  public FileMetadata setType(byte type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public FileMetadata setVersion(byte version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public FileMetadata setData(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> data) {
    this.data = data;
    return this;
  }
