...
public class WriteNotificationLogRequest implements org.apache.thrift.TBase<WriteNotificationLogRequest, WriteNotificationLogRequest._Fields>, java.io.Serializable, Cloneable, Comparable<WriteNotificationLogRequest> {
  ...
  public WriteNotificationLogRequest setTxnId(long txnId) {
    this.txnId = txnId;
    setTxnIdIsSet(true);
    return this;
  }
  ...
  public WriteNotificationLogRequest setWriteId(long writeId) {
    this.writeId = writeId;
    setWriteIdIsSet(true);
    return this;
  }
  ...
  public WriteNotificationLogRequest setDb(@org.apache.thrift.annotation.Nullable java.lang.String db) {
    this.db = db;
    return this;
  }
  ...
  public WriteNotificationLogRequest setTable(@org.apache.thrift.annotation.Nullable java.lang.String table) {
    this.table = table;
    return this;
  }
  ...
  public WriteNotificationLogRequest setFileInfo(@org.apache.thrift.annotation.Nullable InsertEventRequestData fileInfo) {
    this.fileInfo = fileInfo;
    return this;
  }
  ...
  public WriteNotificationLogRequest setPartitionVals(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> partitionVals) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (fileInfo == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'fileInfo' was not present! Struct: " + toString());
    }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1077 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter1078 : struct.partitionVals)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list1079.size);
          ...
          for (int _i1081 = 0; _i1081 < _list1079.size; ++_i1081)
          {
            ...
            struct.partitionVals.add(_elem1080);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
