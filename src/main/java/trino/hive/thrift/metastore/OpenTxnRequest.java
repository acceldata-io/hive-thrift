...
public class OpenTxnRequest implements org.apache.thrift.TBase<OpenTxnRequest, OpenTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<OpenTxnRequest> {
  ...
  public OpenTxnRequest() {
    ...
    this.txn_type = io.trino.hive.thrift.metastore.TxnType.DEFAULT;
  ...
  public OpenTxnRequest setNumTxns(int num_txns) {
    this.num_txns = num_txns;
    setNumTxnsIsSet(true);
    return this;
  }

  public void unsetNumTxns() {
  ...
  public OpenTxnRequest setUser(@org.apache.thrift.annotation.Nullable java.lang.String user) {
    this.user = user;
    return this;
  }
  ...
  public OpenTxnRequest setHostname(@org.apache.thrift.annotation.Nullable java.lang.String hostname) {
    this.hostname = hostname;
    return this;
  }
  ...
  public OpenTxnRequest setAgentInfo(@org.apache.thrift.annotation.Nullable java.lang.String agentInfo) {
  ...
  public OpenTxnRequest setReplPolicy(@org.apache.thrift.annotation.Nullable java.lang.String replPolicy) {
  ...
  public OpenTxnRequest setReplSrcTxnIds(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> replSrcTxnIds) {
   ...
   * @see TxnType
   */
  public OpenTxnRequest setTxnType(@org.apache.thrift.annotation.Nullable TxnType txn_type) {
    this.txn_type = txn_type;
    return this;
  }

  public void unsetTxnType() {
    this.txn_type = null;
  }

  /** Returns true if field txn_type is set (has been assigned a value) and false otherwise */
  public boolean isSetTxnType() {
    return this.txn_type != null;
  }

  public void setTxnTypeIsSet(boolean value) {
    if (!value) {
      this.txn_type = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case NUM_TXNS:
      if (value == null) {
        ...
        setNumTxns((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(OpenTxnRequest that) {
    ...
    boolean this_present_txn_type = true && this.isSetTxnType();
    boolean that_present_txn_type = true && that.isSetTxnType();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTxnType()) ? 131071 : 524287);
    if (isSetTxnType())
  ...
  public int compareTo(OpenTxnRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNumTxns(), other.isSetNumTxns());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTxnType(), other.isSetTxnType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTxnType()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, OpenTxnRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // TXN_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.txn_type = io.trino.hive.thrift.metastore.TxnType.findByValue(iprot.readI32());
              struct.setTxnTypeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
