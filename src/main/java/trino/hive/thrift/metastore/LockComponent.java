...
public class LockComponent implements org.apache.thrift.TBase<LockComponent, LockComponent._Fields>, java.io.Serializable, Cloneable, Comparable<LockComponent> {
  ...
  public LockComponent() {
    this.operationType = io.trino.hive.thrift.metastore.DataOperationType.UNSET;
   ...
   * @see LockType
   */
  public LockComponent setType(@org.apache.thrift.annotation.Nullable LockType type) {
    this.type = type;
    return this;
  }
   ...
   * @see LockLevel
   */
  public LockComponent setLevel(@org.apache.thrift.annotation.Nullable LockLevel level) {
    this.level = level;
    return this;
  }
  ...
  public LockComponent setDbname(@org.apache.thrift.annotation.Nullable java.lang.String dbname) {
    this.dbname = dbname;
    return this;
  }
  ...
  public LockComponent setTablename(@org.apache.thrift.annotation.Nullable java.lang.String tablename) {
  ...
  public LockComponent setPartitionname(@org.apache.thrift.annotation.Nullable java.lang.String partitionname) {
   ...
   * @see DataOperationType
   */
  public LockComponent setOperationType(@org.apache.thrift.annotation.Nullable DataOperationType operationType) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, LockComponent struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // LEVEL
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.level = io.trino.hive.thrift.metastore.LockLevel.findByValue(iprot.readI32());
          ...
          case 6: // OPERATION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.operationType = io.trino.hive.thrift.metastore.DataOperationType.findByValue(iprot.readI32());
