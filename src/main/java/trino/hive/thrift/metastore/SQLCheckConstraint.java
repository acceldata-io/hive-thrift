...
public class SQLCheckConstraint implements org.apache.thrift.TBase<SQLCheckConstraint, SQLCheckConstraint._Fields>, java.io.Serializable, Cloneable, Comparable<SQLCheckConstraint> {
  ...
  public SQLCheckConstraint(SQLCheckConstraint other) {
    ...
    if (other.isSetCheckExpression()) {
      this.check_expression = other.check_expression;
    }
    if (other.isSetDcName()) {
  ...
  public SQLCheckConstraint setCatName(@org.apache.thrift.annotation.Nullable java.lang.String catName) {
    this.catName = catName;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getTableDb() {
    return this.table_db;
  }

  public SQLCheckConstraint setTableDb(@org.apache.thrift.annotation.Nullable java.lang.String table_db) {
    this.table_db = table_db;
    return this;
  }
  ...
  public SQLCheckConstraint setTableName(@org.apache.thrift.annotation.Nullable java.lang.String table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public SQLCheckConstraint setColumnName(@org.apache.thrift.annotation.Nullable java.lang.String column_name) {
    this.column_name = column_name;
    return this;
  }
  ...
  public SQLCheckConstraint setCheckExpression(@org.apache.thrift.annotation.Nullable java.lang.String check_expression) {
    this.check_expression = check_expression;
    return this;
  }
  ...
  public SQLCheckConstraint setDcName(@org.apache.thrift.annotation.Nullable java.lang.String dc_name) {
    this.dc_name = dc_name;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TABLE_DB:
      if (value == null) {
        ...
        setTableDb((java.lang.String)value);
      }
      break;
    ...
    case CHECK_EXPRESSION:
      if (value == null) {
        ...
        setCheckExpression((java.lang.String)value);
      }
      break;
    ...
    case DC_NAME:
      if (value == null) {
        ...
        setDcName((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(SQLCheckConstraint that) {
    ...
    boolean this_present_table_db = true && this.isSetTableDb();
    boolean that_present_table_db = true && that.isSetTableDb();
    ...
    boolean this_present_check_expression = true && this.isSetCheckExpression();
    boolean that_present_check_expression = true && that.isSetCheckExpression();
    ...
    boolean this_present_dc_name = true && this.isSetDcName();
    boolean that_present_dc_name = true && that.isSetDcName();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTableDb()) ? 131071 : 524287);
    if (isSetTableDb())
    ...
    hashCode = hashCode * 8191 + ((isSetCheckExpression()) ? 131071 : 524287);
    if (isSetCheckExpression())
      hashCode = hashCode * 8191 + check_expression.hashCode();

    hashCode = hashCode * 8191 + ((isSetDcName()) ? 131071 : 524287);
    if (isSetDcName())
  ...
  public int compareTo(SQLCheckConstraint other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTableDb(), other.isSetTableDb());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTableDb()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCheckExpression(), other.isSetCheckExpression());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCheckExpression()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDcName(), other.isSetDcName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDcName()) {
        ...
        switch (schemeField.id) {
          ...
          case 5: // CHECK_EXPRESSION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setCheckExpressionIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
  ...
  private static class SQLCheckConstraintTupleScheme extends org.apache.thrift.scheme.TupleScheme<SQLCheckConstraint> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, SQLCheckConstraint struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCheckExpression()) {
        optionals.set(4);
      }
      if (struct.isSetDcName()) {
        optionals.set(5);
      }
