...
public class GetPartitionsFilterSpec implements org.apache.thrift.TBase<GetPartitionsFilterSpec, GetPartitionsFilterSpec._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsFilterSpec> {
   ...
   * @see PartitionFilterMode
   */
  public GetPartitionsFilterSpec setFilterMode(@org.apache.thrift.annotation.Nullable PartitionFilterMode filterMode) {
  ...
  public GetPartitionsFilterSpec setFilters(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> filters) {
        ...
        switch (schemeField.id) {
          case 7: // FILTER_MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.filterMode = io.trino.hive.thrift.metastore.PartitionFilterMode.findByValue(iprot.readI32());
