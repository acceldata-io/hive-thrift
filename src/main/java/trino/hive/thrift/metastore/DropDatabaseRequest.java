...
public class DropDatabaseRequest implements org.apache.thrift.TBase<DropDatabaseRequest, DropDatabaseRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DropDatabaseRequest> {
  ...
  public DropDatabaseRequest setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public DropDatabaseRequest setCatalogName(@org.apache.thrift.annotation.Nullable java.lang.String catalogName) {
  ...
  public DropDatabaseRequest setIgnoreUnknownDb(boolean ignoreUnknownDb) {
    this.ignoreUnknownDb = ignoreUnknownDb;
    setIgnoreUnknownDbIsSet(true);
    return this;
  }
  ...
  public DropDatabaseRequest setDeleteData(boolean deleteData) {
    this.deleteData = deleteData;
    setDeleteDataIsSet(true);
    return this;
  }
  ...
  public DropDatabaseRequest setSoftDelete(boolean softDelete) {
  ...
  public DropDatabaseRequest setTxnId(long txnId) {
    this.txnId = txnId;
    setTxnIdIsSet(true);
    return this;
  }
  ...
  public DropDatabaseRequest setDeleteManagedDir(boolean deleteManagedDir) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'ignoreUnknownDb' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'deleteData' because it's a primitive and you chose the non-beans generator.
  ...
  private static class DropDatabaseRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<DropDatabaseRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DropDatabaseRequest struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetIgnoreUnknownDb()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'ignoreUnknownDb' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetDeleteData()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'deleteData' was not found in serialized data! Struct: " + toString());
      }
