...
public class DoubleColumnStatsData implements org.apache.thrift.TBase<DoubleColumnStatsData, DoubleColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<DoubleColumnStatsData> {
  ...
  public DoubleColumnStatsData setBitVectors(byte[] bitVectors) {
    this.bitVectors = bitVectors == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(bitVectors.clone());
    return this;
  }

  public DoubleColumnStatsData setBitVectors(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer bitVectors) {
  ...
  public DoubleColumnStatsData setHistogram(byte[] histogram) {
    this.histogram = histogram == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(histogram.clone());
    return this;
  }

  public DoubleColumnStatsData setHistogram(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer histogram) {
