...
public class CompactionMetricsDataStruct implements org.apache.thrift.TBase<CompactionMetricsDataStruct, CompactionMetricsDataStruct._Fields>, java.io.Serializable, Cloneable, Comparable<CompactionMetricsDataStruct> {
  ...
  public CompactionMetricsDataStruct setDbname(@org.apache.thrift.annotation.Nullable java.lang.String dbname) {
    this.dbname = dbname;
    return this;
  }
  ...
  public CompactionMetricsDataStruct setTblname(@org.apache.thrift.annotation.Nullable java.lang.String tblname) {
    this.tblname = tblname;
    return this;
  }
  ...
  public CompactionMetricsDataStruct setPartitionname(@org.apache.thrift.annotation.Nullable java.lang.String partitionname) {
   ...
   * @see CompactionMetricsMetricType
   */
  public CompactionMetricsDataStruct setType(@org.apache.thrift.annotation.Nullable CompactionMetricsMetricType type) {
    this.type = type;
    return this;
  }
  ...
  public CompactionMetricsDataStruct setMetricvalue(int metricvalue) {
    this.metricvalue = metricvalue;
    setMetricvalueIsSet(true);
    return this;
  }
  ...
  public CompactionMetricsDataStruct setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public CompactionMetricsDataStruct setThreshold(int threshold) {
    this.threshold = threshold;
    setThresholdIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'metricvalue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'version' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'threshold' because it's a primitive and you chose the non-beans generator.
  ...
  private static class CompactionMetricsDataStructStandardScheme extends org.apache.thrift.scheme.StandardScheme<CompactionMetricsDataStruct> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, CompactionMetricsDataStruct struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = io.trino.hive.thrift.metastore.CompactionMetricsMetricType.findByValue(iprot.readI32());
      ...
      if (!struct.isSetMetricvalue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'metricvalue' was not found in serialized data! Struct: " + toString());
      }
      ...
      if (!struct.isSetThreshold()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'threshold' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
