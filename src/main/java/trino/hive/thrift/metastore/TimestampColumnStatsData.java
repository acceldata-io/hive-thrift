...
public class TimestampColumnStatsData implements org.apache.thrift.TBase<TimestampColumnStatsData, TimestampColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<TimestampColumnStatsData> {
  ...
  public TimestampColumnStatsData setHistogram(byte[] histogram) {
    this.histogram = histogram == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(histogram.clone());
    return this;
  }

  public TimestampColumnStatsData setHistogram(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer histogram) {
